...
CategoryBlueprint {
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            ST.SliderValue {
                label: "Edge Horizontal Padding"
                from: 0
                to: 20
                value: C.Config.settings.bar.addHorizontalEdgePad
                onMoved: C.Config.settings.bar.addHorizontalEdgePad = Math.round(value)
            }
        ...
        ColumnLayout {
            ...
            CW.ValueSwitch {
                label: "Only open"
                checked: C.Config.settings.bar.workspaces.onlyOpen
                onToggled: C.Config.settings.bar.workspaces.onlyOpen = checked
                Layout.fillWidth: true
            }
            ...
            CW.ValueSwitch {
                ...
                checked: C.Config.settings.bar.battery.showSystemStats
                onToggled: C.Config.settings.bar.battery.showSystemStats = checked
                Layout.fillWidth: true
            }
